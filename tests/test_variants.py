...
from biothings_typed_client.variants import TypedVariantClient, TypedVariantClientAsync, VariantResponse
...
@pytest.fixture
def sync_client():
    return TypedVariantClient()

@pytest.fixture
def async_client():
    return TypedVariantClientAsync()

def test_getvariant_sync(sync_client: TypedVariantClient):
...
@pytest.mark.asyncio
async def test_getvariant_async(async_client: TypedVariantClientAsync):
...
def test_getvariants_sync(sync_client: TypedVariantClient):
...
@pytest.mark.asyncio
async def test_getvariants_async(async_client: TypedVariantClientAsync):
...
def test_query_sync(sync_client: TypedVariantClient):
...
@pytest.mark.asyncio
async def test_query_async(async_client: TypedVariantClientAsync):
...
def test_querymany_sync(sync_client: TypedVariantClient):
...
@pytest.mark.asyncio
async def test_querymany_async(async_client: TypedVariantClientAsync):
...
def test_get_fields_sync(sync_client: TypedVariantClient):
...
@pytest.mark.asyncio
async def test_get_fields_async(async_client: TypedVariantClientAsync):
...
def test_metadata_sync(sync_client: TypedVariantClient):
...
@pytest.mark.asyncio
async def test_metadata_async(async_client: TypedVariantClientAsync):
